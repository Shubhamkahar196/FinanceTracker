...
const HomePage: React.FC = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-sky-500/50 flex flex-col justify-center items-center py-12 px-4 sm:px-6 lg:px-8">
      <Head>
      ...
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="mt-6 text-5xl font-extrabold text-pink-500 drop-shadow-lg">
